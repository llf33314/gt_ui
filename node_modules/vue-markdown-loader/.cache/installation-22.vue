<template><section><h2 id="an-zhuang"><a class="header-anchor" href="#an-zhuang" aria-hidden="true">¶</a> 安装</h2>
<h3 id="npm-an-zhuang"><a class="header-anchor" href="#npm-an-zhuang" aria-hidden="true">¶</a> npm 安装</h3>
<p>推荐使用 npm 的方式安装，它能更好地和 <a href="https://webpack.js.org/">webpack</a> 打包工具配合使用。</p>
<pre><code class="hljs language-shell">npm i element-ui -S
</code></pre>
<h3 id="cdn"><a class="header-anchor" href="#cdn" aria-hidden="true">¶</a> CDN</h3>
...
<span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">"stylesheet"</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"https://unpkg.com/element-ui/lib/theme-default/index.css"</span>&gt;</span>
...
<h3 id="hello-world"><a class="header-anchor" href="#hello-world" aria-hidden="true">¶</a> Hello world</h3>
<p>通过 CDN 的方式我们可以很容易地使用 Element 写出一个 Hello world 页面。<a href="http://codepen.io/QingWei-Li/pen/vXwJrY">在线演示</a></p>
...
<span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"app"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"visible = true"</span>&gt;</span>按钮<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">el-dialog</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">"visible"</span> <span class="hljs-attr">title</span>=<span class="hljs-string">"Hello world"</span>&gt;</span>
