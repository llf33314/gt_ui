...
<h2 id="dialog-dui-hua-kuang"><a class="header-anchor" href="#dialog-dui-hua-kuang" aria-hidden="true">¶</a> Dialog 对话框</h2>
...
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-button type=\&quot;text\&quot; @click=\&quot;dialogVisible = true\&quot;&gt;点击打开 Dialog&lt;/el-button&gt;\n\n&lt;el-dialog title=\&quot;提示\&quot; :visible.sync=\&quot;dialogVisible\&quot; size=\&quot;tiny\&quot; :before-close=\&quot;handleClose\&quot;&gt;\n  &lt;span&gt;这是一段信息&lt;/span&gt;\n  &lt;span slot=\&quot;footer\&quot; class=\&quot;dialog-footer\&quot;&gt;\n    &lt;el-button @click=\&quot;dialogVisible = false\&quot;&gt;取 消&lt;/el-button&gt;\n    &lt;el-button type=\&quot;primary\&quot; @click=\&quot;dialogVisible = false\&quot;&gt;确 定&lt;/el-button&gt;\n  &lt;/span&gt;\n&lt;/el-dialog&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    data() {\n      return {\n        dialogVisible: false\n      };\n    },\n    methods: {\n      handleClose(done) {\n        this.$confirm('确认关闭？')\n          .then(_ =&gt; {\n            done();\n          })\n          .catch(_ =&gt; {});\n      }\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-button type="text" @click="dialogVisible = true">点击打开 Dialog</el-button>
...
<el-dialog title="提示" :visible.sync="dialogVisible" size="tiny" :before-close="handleClose">
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="dialogVisible = false">确 定</el-button>
                    ...
                    <p>需要设置<code>visible</code>属性，它接收<code>Boolean</code>，当为<code>true</code>时显示 Dialog。Dialog 分为两个部分：<code>body</code>和<code>footer</code>，<code>footer</code>需要具名为<code>footer</code>的<code>slot</code>。<code>title</code>属性用于定义标题，它是可选的，默认值为空。最后，本例还展示了<code>beforeClose</code>的用法。</p>

                    <div class="highlight" slot="highlight"><pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"dialogVisible = true"</span>&gt;</span>点击打开 Dialog<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
...
<el-dialog title="收货地址" :visible.sync="dialogFormVisible">
  ...
  <div slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="dialogFormVisible = false">确 定</el-button>
                    ...
                    <div class="highlight" slot="highlight"><pre><code class="hljs language-html"><span class="hljs-comment">&lt;!-- Table --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"dialogTableVisible = true"</span>&gt;</span>打开嵌套表格的 Dialog<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">el-dialog</span> <span class="hljs-attr">title</span>=<span class="hljs-string">"收货地址"</span> <span class="hljs-attr">:visible.sync</span>=<span class="hljs-string">"dialogTableVisible"</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"dialogFormVisible = true"</span>&gt;</span>打开嵌套表单的 Dialog<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">el-dialog</span> <span class="hljs-attr">title</span>=<span class="hljs-string">"收货地址"</span> <span class="hljs-attr">:visible.sync</span>=<span class="hljs-string">"dialogFormVisible"</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"footer"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dialog-footer"</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"primary"</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"dialogFormVisible = false"</span>&gt;</span>确 定<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
